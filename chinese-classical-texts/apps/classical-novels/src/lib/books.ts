      ...
      return withDevStudio(slug, [
        ...
        { key: 'items', glyph: '宝', title: '法宝谱系', desc: '制造 · 拥有 · 克制关系', ...live(has('items'), slug, 'items', `/${slug}/items`) },
        {
          ...
          preview: {
            ...
            phases: [
              '✅ X1 建 event 实体与回目锚点（81 难）',
              '✅ X2 难—妖—宝—地 四元关联（妖怪页收服者/原型连接）',
              '✅ X3 交互时间轴 + 收服者阵营/靠山难度统计（NanExplorer）',
            ],
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              '✅ X4 诠释专题 topic（内丹/政治/原型 + 刘一明《西游原旨》）',
              '✅ X4 情境边（scoped_relations）叠加到事件与诠释页',
              '✅ X4 六视角全覆盖（补民俗/叙事/宗教 lens）',
            ],
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              '✅ X1 丹道意象 / 地名隐喻录入（41 条，标注 inference）',
              '✅ X2 五行生克关系边（相克/交并/调和/相济）',
              '✅ X3 五行修心网络（WuxingNetwork）+ quanshi 内丹专题互链',
            ],
        ...
        kaozhengModule(slug, has),
        {
          key: 'edition', glyph: '勘', title: '版本对勘', desc: '世德堂本 vs 通本异文双栏（110 锚点 · 37 回）', ...live(has('compare'), slug, 'edition', `/${slug}/compare`),
        },
      ]);
    case 'jinpingmei':
      return withDevStudio(slug, [
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              ...
              'J2 物—人—地交叉索引（byLocation · 地点 Tab · topics 互链）',
              'J3 物质消费与身份 / 经济关联分析',
            ],
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              ...
              'J3 双栏对勘视图（三对切换 · 异文高亮 · 同步滚动 · compare.json）',
              '✅ 21 锚点 · 回目/措辞/物价/批语 · 词话↔崇祯↔竹坡三对全覆盖',
            ],
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              'P1 名字谶 / 物象谶 / 曲牌宝卷谶 录入（43 条 · inference 标注）',
              'P2 phase + temperature 冷热金针边 · 交叉索引五阶段筛选',
              'P3 因果闭环可视化（ShiKarmaLoop · shi-karma.json · 5 示例链）',
            ],
        ...
        },
        {
          ...
          preview: {
            ...
            phases: [
              ...
              'J2 SNA 介数/度中心性 · 双轴条形图 · 度×介数散点 · 派系筛选',
              'J3 中心性叠加关系图谱（SNA·介数/度 节点大小 · 侧栏指标）',
              'J5 build_sna.json · 帮闲圈 topic · 图谱/白银/衰败链联动',
            ],
