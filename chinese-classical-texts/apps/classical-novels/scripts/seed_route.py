...
def main() -> None:
    ...
    for n in NODES:
        ...
        if "geo" in n:
            lat, lng = n["geo"]
            lines.append(f"geo: {{ lat: {lat}, lng: {lng} }}")
        if "x" in n and "y" in n:
            lines.append(f"coord: {{ x: {n['x']}, y: {n['y']} }}")
